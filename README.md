...
## Deployment
The chatbot is deployed on PythonAnywhere, accessible at [http://cse2020021049.pythonanywhere.com/]. The deployment process involves transferring the files to the PythonAnywhere server, installing dependencies, and configuring the WSGI file to point to the Flask application.
